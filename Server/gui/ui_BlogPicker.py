...
"padding: 0px 5px;")
        ...
        self.BlogPickerClientIpAddress = QtWidgets.QLineEdit(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(False)
        font.setWeight(50)
        self.BlogPickerClientIpAddress.setFont(font)
        self.BlogPickerClientIpAddress.setReadOnly(True)
        self.BlogPickerClientIpAddress.setObjectName("BlogPickerClientIpAddress")
        self.horizontalLayout_3.addWidget(self.BlogPickerClientIpAddress)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "DanialCMS Client ip address:"))
